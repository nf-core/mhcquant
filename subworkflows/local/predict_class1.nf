...
include { PREDICT_POSSIBLE_NEOEPITOPES }                                    from '../../modules/local/predict_possible_neoepitopes'
include { RESOLVE_FOUND_NEOEPITOPES }                                       from '../../modules/local/resolve_found_neoepitopes'
...
workflow PREDICT_CLASS1 {
    ...
    main:
        ...
        if ( params.include_proteins_from_vcf ) {
            ...
            PREDICT_POSSIBLE_NEOEPITOPES(peptides_class_1_alleles.combine(ch_vcf_from_sheet, by:0))
