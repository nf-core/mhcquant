# nf-core/openmspeptidequant: Reference Genomes Configuration

The nf-core/openmspeptidequant pipeline needs a reference genome for alignment and annotation.
